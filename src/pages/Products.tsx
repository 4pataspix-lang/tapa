    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          {/* Banner acima do header também aparece aqui se configurado */}
          {settings?.header_banner_url && (
            <div className="w-full mb-6 sm:mb-8 -mt-6 sm:-mt-8 -mx-4 sm:-mx-6 lg:-mx-8 bg-gray-100">
              <img
                src={settings.header_banner_url}
                alt="Banner"
                className="w-full h-auto max-h-[60px] sm:max-h-[80px] md:max-h-[100px] object-contain"
              />
            </div>
          )}
          
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Todos os Produtos</h1>
          <p className="text-sm sm:text-base text-gray-600">Encontre exatamente o que você está procurando</p>
        </div>
      </div>
